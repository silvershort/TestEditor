...
public class CropView extends View {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        // initial dimensions
        minimumSideLength = ta.getDimensionPixelSize(R.styleable.CropView_minimumSide, 20);
        ...
        //init drawables
        moveDrawable = ta.getDrawable(R.styleable.CropView_moveCornerDrawable);
        resizeDrawable1 = ta.getDrawable(R.styleable.CropView_resizeCornerDrawable);
        resizeDrawable2 = ta.getDrawable(R.styleable.CropView_resizeCornerDrawable);
        resizeDrawable3 = ta.getDrawable(R.styleable.CropView_resizeCornerDrawable);
